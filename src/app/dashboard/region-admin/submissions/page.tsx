...
const RegionAdminSubmissionsPage = () => {
  ...
  // Redirect non-regionAdmin users
  useEffect(() => {
    if (!loading) {
      if (!user) {
  ...
  const fetchSubmissions = async () => {
    try {
      ...
      let url = `/api/admin/submissions?page=${pagination.page}&limit=${pagination.limit}&isRegionAdmin=true`;
      if (statusFilter) {
                      ...
                      <div className="mt-3">
                        ...
                        {interactions.length > 0 &&
                          interactions[0].submissionId === submission._id && (
                            <div className="mt-2 border rounded-md p-3 bg-gray-50 comment-history">
...
export default RegionAdminSubmissionsPage;
