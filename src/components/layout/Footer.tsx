  ...
  return (
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  href="/services/roc-filing/gst-amendment"
                  className="text-gray-300 hover:text-white"
                >
                  GST Amendment
                </Link>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300">
              <p className="mb-2">123 Tax Street</p>
              <p className="mb-2">New Delhi, India 110001</p>
              <p className="mb-2">
                <a href="mailto:info@efiletax.com" className="hover:text-white">
                  info@efiletax.com
                </a>
              </p>
              <p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 flex justify-between items-center text-gray-300">
          <p>
            &copy; {new Date().getFullYear()} eFileTax. All rights reserved.
          </p>
          {user && (
