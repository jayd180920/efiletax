...
export default function GSTAmendment({
  ...
  return (
    <FormSection
      id="gst-amendment"
      title="GST Amendment Documents"
      subtitle="Please upload the required document for GST amendment"
      icon={icon}
      defaultOpen={true}
    >
      <div className="space-y-6">
        <div className="border-t border-gray-200 pt-6">
          ...
          <div className="space-y-4">
            <FileUploadField
              id="amendmentDocFile"
              name="amendmentDocFile"
              label="Amendment Document"
              file={data.amendmentDocFile}
